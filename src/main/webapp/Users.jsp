...
<main class="container">
    <div class="row justify-content-center mt-3">
        <div class="col-12">
            ...
            <form action="Controller?action=postrechercherUser" method="post">
                ...
                <c:forEach var="c" items="${listeU}">
                    <div class="card m-2" style="width: 16rem;">
                            ...
                            <div class="d-flex justify-content-center">
                                <a href="Controller?action=modifierUser&id=${c.id}" class="btn btn-primary">Modifier</a>
                                <a onclick="return confirm('Voulez vous vraiment supprimer cet utilisateur?')" href="Controller?action=supprimerUser?id=${c.id}" class="btn btn-danger">Supprimer</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
