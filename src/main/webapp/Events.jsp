...
<%@page import="dao.entities.Event"%>
        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="Controller?action=addEvent" class="btn btn-primary">Ajouter Event</a>
                </div>
            </div>

            <form action="Controller?action=postrechercherEvent" method="post">
            ...
            <tbody>
                ...
                <c:forEach var="p" items="${listeE}">
                    <tr>
                        ...
                        <td>
                            <a href="Controller?action=modifierEvent&id=${p.id}" class="btn btn-primary">Modifier</a>
                            <a onclick="return confirm('Voulez vous vraiment supprimer cet event?')"
                                href="Controller?action=supprimerEvent&id=${p.id}" class="btn btn-danger">Supprimer</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
