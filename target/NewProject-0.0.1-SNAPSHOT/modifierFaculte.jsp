...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card my-5">
                <div class="card-body">
                    <h3 class="card-title text-center mb-4">Modifier une faculté</h3>
                    <form action="Controller?action=postmodifierFaculte" method="post">
                    <input type="hidden" name="id" value="${faculte.id}">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" value= "${faculte.nomFac}" id="nomFac" name="nomFac" placeholder="Nom Faculté">
