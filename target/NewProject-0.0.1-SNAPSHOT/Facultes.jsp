    ...
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h2 class="h2">Liste Des Facultées</h2>
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="Controller?action=addFaculte" class="btn btn-primary">Ajouter Faculté</a>
                </div>
            </div>
                ...
                <c:forEach var="c" items="${listeF}">
                    <tr>
                        ...
                        <td>
                            ...
                            <a onclick="return confirm('Voulez vous vraiment supprimer cette faculté?')"
