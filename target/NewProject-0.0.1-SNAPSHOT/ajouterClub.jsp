...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card my-5">
                <div class="card-body">
                    <h3 class="card-title text-center mb-4">Ajouter un Club</h3>
                    <form action="Controller?action=postaddClub" method="post">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="nomClub" name="nomClub" placeholder="Nom Club">
                            <label for="nomSociete">Nom Club :</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="descriptionClub" name="descriptionClub" placeholder="Description">
